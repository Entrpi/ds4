...
/* SHA-256 of an arbitrary buffer (the same primitive that fingerprints
 * decoded images); used for the encoder-sidecar half of the image identity. */
void ds4_image_sha256(const void *data, size_t len, uint8_t out[32]);
